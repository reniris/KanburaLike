...
namespace KanburaLike.ViewModels
{
    public class AdmiralViewModel : ViewModel
    {
		...
		/// 家具コインの数を取得します。
		/// </summary>
		public int Coin => this.Model.RawData.api_fcoin;
		...
		public AdmiralViewModel()
		{
			...
			{
				{ nameof(Homeport.Admiral), (sender, args) => this.Update(KanColleClient.Current.Homeport.Admiral) },
			});
		}
