...
{
	public abstract class ValueConverterBase<Source, Target> : IValueConverter
	{
		...
		public abstract Target Convert(Source value, Type targetType, object parameter, CultureInfo culture);
		public abstract Source ConvertBack(Target value, Type targetType, object parameter, CultureInfo culture);
	}
